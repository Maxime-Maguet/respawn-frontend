...
import fallbackImage from "../../assets/backgroundCardImage.png";
...
export default function GameCard({
  ...
  return (
    ...
    >
      <div
        className="h-40 bg-cover bg-center w-full group-hover:brightness-110 transition-all duration-300 relative"
        style={{ backgroundImage: `url(${backgroundImage || fallbackImage})` }}
      >
        <div className="absolute inset-x-0 bottom-0 h-8 bg-linear-to-t from-[#0d1520] to-transparent" />
      </div>
